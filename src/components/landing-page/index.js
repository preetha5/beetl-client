          ...
          <Card className={classes.topcard}>
            ...
            <div className={classes.details}>
              <CardContent className={classes.content}>
                <h2 className={classes.headline}>TRACK BUGS EASILY</h2>
                <div className={classes.bug} />
                <p>
                  <span className={classes.accent}> Easily & Efficiently </span>{" "}
                  manage the issues related to all your products in one
                  responsive app. BEETL is an issue tracking system that can be
                  easily integrated into your software or hardware development
                  cycles. Killing Bugs has never been so much fun.
                </p>
          ...
          <Card className={classes.card}>
            ...
            <CardContent>
              <h6 className={classes.gridded}>
                ADD PRODUCTS + USERS<span className={classes.tiny_headline}>
                  BUILD TEAMS{" "}
                </span>
                <span className={classes.accent}>EASILY</span>
              </h6>
              <p>
                Easily manage all your products and users. As an admin, you have
                the privilege of adding your company products and also adding
                the rest of your development team into the system.
              </p>
              <h6 className={classes.logo}>
                BEETL {"\n"}
                <span className={classes.tagline}>
          ...
          <Card className={classes.card}>
            ...
            <CardContent>
              <h6 className={classes.gridded}>
                ...
                <span className={classes.tiny_headline}>
                  TOGETHER NOW{"\n"}
                </span>
                <span className={classes.accent}>EFFECTIVELY</span>
              </h6>
              <p>
                Any user role can create bugs. Store and retrieve all the relevant
                details related to the bug in an easy to use form. Include BEETL in your
                daily agile processes and team scrum.
              </p>
              <h6 className={classes.logo}>
                BEETL {"\n"}
                <span className={classes.tagline}>
        ...
        <Grid item xs={12} sm={4}>
          <Card className={classes.card}>
            ...
            <CardContent>
              <h6 className={classes.gridded}>
                TRACK ALL STAGES{" "}
                <span className={classes.tiny_headline}>BIRTH to DEATH </span>
                <span className={classes.accent}>EFFICIENTLY</span>
              </h6>
              <p className={classes.content}>
                Update and track issues during all their stages from open to
                built, as the bug moves through the system. Your dashboard shows
                the status of all the bugs across all products succinctly.
              </p>
              <h6 className={classes.logo}>
                BEETL {"\n"}
                <span className={classes.tagline}>
